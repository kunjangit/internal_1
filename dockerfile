...
-Go to Action-security-secrets and variables-
-click action-New repositry secret-
-DOCKER_PASSWORD(DOcker hub password)
-DOCKER_USERNAME(DOcker hub username)
-EC2_SSH_KEY(pem key downloaded)
-HOST_DNS(dns id)

-Go to Action-setup new workflow
-filename(ci.yml)
add code in ci.yml file
